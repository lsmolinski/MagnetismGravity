...
\begin{itemize}
	\item \textbf{Solar light bending} through the spatial gradient of
	\(n_\gamma(r)\),
	\item \textbf{Gravitational redshift} through the internal clock speed
	\(v_{\text{clock}}=\sqrt{\eta}\),
	\item \textbf{Shapiro delay} through the integrated excess of
	\(n_\gamma(r)-1\) along the propagation path.
\end{itemize}
