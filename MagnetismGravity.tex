...
with
\begin{equation}
	M_{\mu} = \frac{\Delta K_{\mu}}{K_e} = \frac{K_{\mu}-K_e}{K_e} = \frac{197}{10} = 19.7.
\end{equation}
...
with
\begin{equation}
	M_{\tau} = \frac{K_{\tau}}{K_e} = \frac{2181}{10} = 218.1.
\end{equation}
...
\noindent
\textit{Note on notation:} $s_\mu$ in Eq.~\eqref{eq:atau_master} denotes the
