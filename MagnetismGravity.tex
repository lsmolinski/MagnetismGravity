...
constitute a dynamic proof of the particle's stability.  A formal nonlinear
wave equation that guarantees this stability is derived in
Section~\ref{sec:nonlinear_stability}, where the geometric constants
$\epsilon_M$ and $\gamma = 1/\epsilon_M$ determine the self‑trapping term.
The implementation of the full nonlinear dynamics is currently in progress
within the OpenWave platform (scalar M3 and vector M4 models,
\url{https://github.com/openwave-labs/openwave}).  Establishing the nonlinear
