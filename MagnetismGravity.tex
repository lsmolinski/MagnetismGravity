...
To avoid ambiguity between energy density ($\rho_E$) of the soliton and the packaging density, the internal  density function $\rho(r)$ is explicitly introduced, defined
\begin{equation}
	\label{eq:rho_r_def}
	\rho(r) = f(r).
\end{equation}
