...
as $K=9$ or $K=11$ lack this balance and break apart.  This hypothesis
...
reinforcing constraints.  The $r^{5}/r^{3}$ argument explains why $K$ cannot
...
integer values are permitted.  The specific value $K=10$ emerges as the
...
\begin{itemize}
	...
	the former restricts the range of allowed $K$, the latter restricts $K$ to
	integer values; together they single out $K=10$.
