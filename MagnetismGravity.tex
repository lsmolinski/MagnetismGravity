...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{Internal Domain ($r^5$):} Dynamic resonance of waves within the spheres (Toroidal/Asymmetric).
		\item \textbf{External Domain ($r^3$):} Static displacement of the spheres themselves (Spherical/Isotropic).
	\end{itemize}
