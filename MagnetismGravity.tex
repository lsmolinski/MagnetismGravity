...
\subsection{Geometric Planck Length}
...
The analytic solution of the self-consistent geometric equation for \(\lambda_l\) is
\begin{equation}
	\lambda_l
	=
	\left[
...
\end{equation}
so the relative deviation is approximately \(0.0276\%\). This is a genuine geometric prediction, not a fit: the only metrical inputs are \(r_e\), \(m_e\), \(c\), and the elementary charge amplitude \(e\).
...
\subsection{Status of Inputs in This Section}
