...
\textbf{Remark on the dimensional status of $c$.}
...
dimensions, not an independent physical input to the theory. This status 
is consistent with the SI 2019 definition, in which $c$ is an exact 
definitional constant rather than a measured quantity.
...
\begin{itemize}
	...
	($m_e, m_\mu, m_\tau$) and quark masses as arbitrary Yukawa coupling 
