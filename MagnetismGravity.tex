...
The $10^{10}$ factor between electron and neutrino densities, $(r_e/r_\nu)^5 = 10^{10}$, is exactly the ratio expected from the ${K_{WC}}^5$ law when comparing $K_e=10$ and $K_\nu=1$. 
Thus the neutrino defines the **lower threshold of quantisation**: $K_{WC}\ge 1$ for spherical solitons, and $K_{WC}\gtrsim 10$ for the ${K_{WC}}^5$ meson mode to yield near‑integer resonances.
