...
\begin{figure}[h!]
	...
	\node (n6) [block, below=of n5] {\textbf{6. THE COSMIC ARCHITECTURE} \\ 
		\textbf{Black Holes (GBH):} Minimal packing limit of the universal structural bond \\ 
		\textbf{Orbital Stability:} Gravitational conjunction providing a repulsive buffer for matter near the horizon \\
