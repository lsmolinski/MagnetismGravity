...
The ratio of the spatial step to the temporal step in the lattice gives the maximum propagation speed in the statutory vacuum:
\begin{equation}
	c \equiv \frac{\lambda_l}{t_p}.
	\label{eq:c_metric_definition_repeat}
\end{equation}
